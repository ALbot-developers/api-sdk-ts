import fs from 'fs';
import type { ResponseLike } from 'albot-api-sdk/internal/to-file';
import { toFile } from 'albot-api-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('albot-api-sdk/core/uploads');
    await expect(
